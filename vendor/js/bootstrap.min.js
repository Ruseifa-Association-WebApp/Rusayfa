  ...
  var X = {
    ...
    J = (function (t) {
      ...
      return (
        ...
        (n.pause = function (t) {
          t || (this._isPaused = !0),
            Q(".carousel-item-next, .carousel-item-prev", this._element) && (p(this._element), this.cycle(!0)),
          ...
          if (s && s.classList.contains("active")) this._isSliding = !1;
            ...
            if (
              ...
              i.classList.remove("active"),
                s.classList.add("active"),
                (this._isSliding = !1),
                K.trigger(this._element, "slid.bs.carousel", { relatedTarget: s, direction: u, from: o, to: r });
            a && this.cycle();
          }
        }),
      ...
      return (
        ...
        (a._initializeOnDelegatedTarget = function (t, e) {
          ...
          return (
            (e = e || L(t.delegateTarget, n)) ||
              ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), k(t.delegateTarget, n, e)),
            e
          );
        }),
        (a._getOffset = function () {
        ...
        (a._getPopperConfig = function (t) {
          ...
          return s(
            {},
            n,
            "function" == typeof this.config.popperConfig ? this.config.popperConfig(n) : this.config.popperConfig
          );
        }),
